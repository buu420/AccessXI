...
data.fixed_titles = T{
    ...
    { menus = T{ 'menu    auc1' }, title = 'Auction House' },
    { menus = T{ 'menu    auc2' }, title = 'Auction' },
    { menus = T{ 'menu    aucweapo' }, title = 'Weapons' },
    { menus = T{ 'menu    aucarmor' }, title = 'Armor' },
    { menus = T{ 'menu    aucmagic' }, title = 'Magic Scrolls' },
{ menus = T{ 'menu    aucmater' }, title = 'Materials' },
{ menus = T{ 'menu    aucfood' }, title = 'Food' },
{ menus = T{ 'menu    aucmeals' }, title = 'Meals' },
{ menus = T{ 'menu    aucitem' }, title = 'Others' },
{ menus = T{ 'menu    auclist' }, title = 'Bid' },
{ menus = T{ 'menu    auc3' }, title = 'Auction' },
{ menus = T{ 'menu    auchisto' }, title = 'Price History' },
