...
Invoke-Checked {
    cmake --build $build --config $Configuration --target accessxi_pol_nvda accessxi_pol_native_asi pol_native_queue_tests pol_postlogin_trace_tests pol_prelogin_semantics_tests pol_pml_selected_text_tests pol_native_speech_worker_tests pol_native_host_tests
