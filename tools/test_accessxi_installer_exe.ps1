...
Assert-Contains $programSource 'cleaning old AccessXI Reloaded files' 'Installer progress must disclose ownership-bounded migration cleanup.'
...
Assert-Contains $buildSource 'test_legacy_reloaded_cleanup\.ps1' 'Exe build must validate ownership-bounded legacy cleanup before embedding it.'
